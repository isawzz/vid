...
function _startStep() {
	...
	//#region prelims
	//reset_zoom_on_resize(); //TODO: bug fix!
	clearStep();
	...
	rPreProcessActions();	//calc tupleGroups
	...
	clearDOM(); //only do it no incase of async status repeat on waiting_for!

	if (RUNTEST && TESTING) { runTest(); return; }
	//#endregion prelims

	// *** presentation table and players starts here ***
	let VERSION = 0;
